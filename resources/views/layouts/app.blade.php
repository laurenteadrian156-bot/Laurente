...
<head>
    ...
    <title>{{ config('app.name', 'CatIsland') }}</title>
...
<body class="layout-fixed sidebar-expand-lg  bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-inv-primary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand text-inv-primary"> <!--begin::Brand Link-->
                <a href="/" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="{{ asset('admin-lte/assets/img/AdminLTELogo.png') }}" alt="DS"
                        class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span
                        class="brand-text fw-light ">{{ env('APP_NAME', 'CatIsland') }}</span> <!--end::Brand Text--> </a>
                <!--end::Brand Link-->
